...
export const Projects = () => {
    ...
    return (
        <section ref={targetRef} className="relative h-[300vh] bg-surface-container-low" id="projects">
            <div className="sticky top-0 h-screen flex flex-col overflow-hidden pt-32">
                <div className="w-full max-w-7xl mx-auto px-8 mb-10 shrink-0">
                    <div className="flex justify-between items-end">
                        ...
                        <div className="hidden md:block tech-readout text-right whitespace-pre-line">
                            {readout}
                        </div>
                    </div>
                </div>
